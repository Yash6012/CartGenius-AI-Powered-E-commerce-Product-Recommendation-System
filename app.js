...
const PRODUCTS = [
    {
        ...
        price: 429.99,
        rating: 4.8,
        description: "12-core, 24-thread processor built on AMD’s Zen 4 architecture with exceptional performance for gaming and content creation.",
        brand: "AMD",
        in_stock: true,
        features: ["12-core", "zen4", "overclocking", "energy-efficient"]
    },
    {
        product_id: "P002",
        ...
        price: 419.99,
        rating: 4.7,
        description: "13th Gen Intel Core processor with hybrid performance architecture and high boost speeds for multitasking.",
        brand: "Intel",
        in_stock: true,
        features: ["13th-gen", "hybrid-core", "overclockable", "multitasking"]
    },
    {
        product_id: "P003",
        name: "Corsair Vengeance DDR5 32GB RAM (2x16GB)",
        category: "Memory",
        price: 164.99,
        rating: 4.6,
        description: "High-speed DDR5 memory optimized for latest Intel and AMD platforms delivering next-level performance.",
        brand: "Corsair",
        in_stock: true,
        features: ["ddr5", "high-speed", "dual-channel", "low-latency"]
    },
    {
        product_id: "P004",
        ...
        price: 799.99,
        rating: 4.9,
        description: "Powerful next-gen GPU featuring DLSS 3, ray tracing, and 12GB GDDR6X VRAM for ultra-smooth gaming.",
        brand: "NVIDIA",
        in_stock: true,
        features: ["dlss3", "ray-tracing", "12gb-vram", "gddr6x"]
    },
    {
        product_id: "P005",
        ...
        price: 189.99,
        rating: 4.8,
        description: "Blazing-fast PCIe 4.0 NVMe SSD offering incredible read/write speeds for gamers and creators.",
        brand: "Samsung",
        in_stock: true,
        features: ["pcie4.0", "nvme", "2tb", "high-endurance"]
    },
    {
        product_id: "P006",
        name: "ASUS ROG STRIX X670E Motherboard",
        category: "Motherboard",
        price: 349.99,
        rating: 4.7,
        description: "High-performance AM5 motherboard with PCIe 5.0, DDR5 support, and advanced cooling for Ryzen CPUs.",
        brand: "ASUS",
        in_stock: true,
        features: ["am5", "ddr5", "pcie5.0", "overclocking"]
    },
    {
        product_id: "P007",
        name: "Cooler Master V850 Gold PSU 850W",
        category: "Power Supply",
        price: 129.99,
        rating: 4.5,
        description: "Fully modular 850W PSU with 80+ Gold efficiency, silent fan, and durable Japanese capacitors.",
        brand: "Cooler Master",
        in_stock: true,
        features: ["modular", "80plus-gold", "silent-fan", "durable"]
    },
    {
        product_id: "P008",
        name: "NZXT Kraken Z73 RGB Liquid Cooler",
        category: "Cooling",
        price: 249.99,
        rating: 4.6,
        description: "360mm AIO liquid cooler with customizable LCD display and RGB fans for superior thermal control.",
        brand: "NZXT",
        in_stock: true,
        features: ["aio", "rgb", "lcd-display", "silent-cooling"]
    },
    {
        product_id: "P009",
        ...
        price: 159.99,
        rating: 4.7,
        description: "Premium tempered glass mid-tower case with modular layout and excellent airflow support.",
        brand: "Lian Li",
        in_stock: true,
        features: ["tempered-glass", "modular", "dual-chamber", "rgb"]
    },
    {
        product_id: "P010",
        ...
        price: 89.99,
        rating: 4.4,
        description: "Reliable 7200RPM hard drive for high-capacity storage with proven durability and performance.",
        brand: "Seagate",
        in_stock: true,
        features: ["4tb", "sata", "reliable", "high-capacity"]
    }
];
